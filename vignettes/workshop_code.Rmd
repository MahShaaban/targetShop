...
paralog of YY1. Similarly, it is a zinc finger protein with both activation or 
...
gene expression profiling using microarrays of YY1/YY2 knockdown and control HeLa
...
if(!file.exists('data.zip')) {
  # increase this value if your internet exceptionally slow.
  options(timeout = 200)
  ...
  # check the directory
  if (dir.exists("data")){ print("The Data Extracted Successfully!")}
}
```
